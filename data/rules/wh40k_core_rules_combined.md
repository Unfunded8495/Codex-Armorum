...
In the grim darkness of the far future, Humanity teeters upon the brink of extinction. The galaxy-spanning Imperium, beset on all sides by ravening aliens, foul traitors and warp-spawned daemons, looks once more to its greatest heroes to stave off the encroaching darkness.
...
Each section and subsection is marked with a reference number; these are used for internal referencing. The table below lists each section by page number.

**INTRODUCTION** ... pg 4-5

## BASIC RULES (pg 6-25)

The essential rules concepts of Warhammer 40,000, including how to use datasheets and how to move and attack with your models.

* 

  1. CORE CONCEPTS ... pg 8
* 
...
* 
  ...
  4. MAKING ATTACKS ... pg 16
* 

  5. ATTACK SEQUENCE ... pg 18
* 

  6. OTHER CONCEPTS ... pg 24

## THE BATTLE ROUND (pg 26-43)

Warhammer 40,000 is played in a series of battle rounds in which each player takes a turn consisting of five phases.

* 

  7. THE BATTLE ROUND ... pg 28
* 

  8. COMMAND PHASE ... pg 30
* 

  9. MOVEMENT PHASE ... pg 32
* 
...
## BATTLEFIELDS AND TACTICS (pg 44-59)

This section explains how to create an exciting battlefield using terrain and **objectives**, and how to use tactical tools in the form of **stratagems** and **actions**.
...
## ADVANCED RULES (pg 60-75)

This section explains how to use more specialised types of units, as well as how to reinforce your army with units that are not yet on the battlefield.
...
Abilities that are universal to many units and weapons in Warhammer 40,000 are presented here, along with an introduction to the reference materials found in the Warhammer 40,000 app.
...
\[Full-page photograph of a painted Adeptus Mechanicus army arrayed across industrial terrain. No body text.]
...
Welcome to the Warhammer 40,000 Core Rules. The following pages contain everything you need to know in order to wage battle across the war-torn galaxy of the 41st millennium.
...
\[Photograph of two players moving miniatures across a terrain-filled battlefield.]
...
\[Full-page battle scene artwork showing Blood Angels and Dark Angels Space Marines fighting Tyranids amid gothic ruins. No body text.]
...
\[Full-page section divider photograph of a Blood Angels army battling Tyranids across battlefield terrain.]
...
To make a **battle-shock roll** for a unit, its controlling player makes a **leadership roll** for it (see above).
...
## Diagram: Moving in a Straight Line
...
*Models without a base are rotated around their central axis (see Frame, 17.02).*
...
**If You Cannot Set Up a Unit**

*This section explains how to set up your units on the battlefield. While doing so as the result of a move type, if you have to return a unit's models to their previous positions because it is not possible to set them all up, that unit has not been selected to make that move. This means it can be selected to make a move later, so could either attempt another set up or remain stationary (09.04).*
...
**Models Without Ranged/Melee Weapons**
...
## Diagram: Making Attacks

*\[Worked example showing a RED unit (2 boltguns, 2 bolt pistols, 1 heavy bolter) targeting a BLUE unit.]*
...
# 05\. Attack Sequence Examples (continued)

*Page 21 | Section 05*

## Diagram: Resolving Attack Dice
...
## Diagram: Resolving Other Attacks
...
## Diagram: Attacking Attached Units

*\[Worked example showing a RED unit (7 boltguns, 1 plasma pistol, 2 heavy bolters) targeting a BLUE attached unit.]*
...
Other models and units can be either **visible** or **fully visible** to the observing model, as shown opposite. Note that terrain applies additional rules to visibility (13.07).
...
\[Full-page photograph of Aeldari forces battling Drukhari around a glowing crystal monolith on a craftworld-style battlefield. No body text.]
...
\[Full-page section divider photograph of Aeldari and Drukhari forces engaged across a craftworld battlefield.]
...
Each turn consists of seven parts: first the Start of Turn step, then a series of five phases resolved in the order shown opposite, then the End of Turn step.
...
# 07\. The Battle Round (turn structure)

*Page 29 | Section 07*

The seven parts of a player's turn:
...
6. **FIGHT PHASE** - Both players' units make attacks with their melee weapons.
...
In the Command phase, both players gain Core CP, then you check the combat readiness of your forces and use any strategic-level abilities you may have.
...
# 08\. Command Phase (examples)

*Page 31 | Section 08*

## Diagram: Battle-shock Examples
...
*When the Move Units step ends, the active player must have selected all of their units to make a move with, including those in strategic reserves. This means that before the phase ends, every unit in their army will have been selected to make a move, even if it is to remain stationary.*

*Move types are marked with this icon.*
...
*Some rules instruct you to select a mode, such as fall-back moves (see left). Modes are mutually exclusive, and you must assess each one in the order presented. When making a move, if your unit does not meet the conditions of any of the modes, it cannot make that move.*
...
In the Shooting phase, your units will take aim and use their ranged weapons to fire at their chosen targets.
...
The active player shoots with their eligible units one at a time, using the sequence below, until all the units they choose to shoot with have been **selected to shoot** and their attacks have been resolved.
...
*Shooting types are marked with this icon.*
...
# 10\. Shooting Phase (shooting types)
...
In the Charge phase, you will be able to make charge moves with your units. This represents your forces closing the distance with their foes in order to engage them in bloody close combat.
...
The active player resolves **charges** with their eligible units one at a time, using the sequence below, until all of their units they choose to **charge** with have **declared a charge** and those **charges** have been resolved.

1. **Declare Charge:** Select one friendly unit that has not **declared a charge** this phase and is **eligible to declare a charge** (see below). That unit **declares a charge**.
...
3. **Attempt Charge:** If it is possible to make a **charge move**, and if you still want to, make a **charge move** with that unit (see opposite). Otherwise, your unit does not make a **charge move**. In either case, the **charge** is then resolved.
   ...
   *Note that, in the absence of modifiers to the charge roll, a result of 2 (a double 1) is never sufficient for a unit to complete a charge move, as a unit cannot be within engagement range (2") when it attempts a charge. Such a roll would therefore result in a failed charge, and the unit would not move.*
...
* **After Moving:**
  ...
  * Until the end of the turn, each model in your unit has the **Fights First** ability (24.13).
  ...
  ## Diagram: Making a Charge Move

* **A)** *The BLUE unit declares a charge and the charge roll generates a maximum distance of 7". Unit A is within this distance, so can be selected as a charge target, but the BLUE unit would not be able to end its charge move engaged with this unit after moving around the intervening terrain features.*
* **B)** *This unit is more than 7" from the charging unit, so it cannot be selected as a charge target, even though the charging unit could end its charge move within 2" of this unit.*
* **C)** *These units are both within 7", so can be selected as charge targets. The charging unit can end its charge move engaged with all of its charge targets, so this move can be made.*
...
* **After Moving:**
  ...
  *Yes, you have to fight with all units that can, but you don't have to pile in or consolidate with a unit if you don't want to.*
  ...
  *++ Brave soldiers do not question, they simply act ++*
  ...
  # 12\. Fight Phase (diagrams)

  *Page 39 | Section 12*

  ## Diagram: Start of Fight Phase
  ...
  *Because both RED units made charge moves this turn, they are both Fights First units this phase and are both eligible to make pile-in moves, even though the MONSTER is unengaged as it destroyed its charge target in the Charge phase using the Crushing Impact stratagem (15.06).*
  ...
  ## Diagram: Pile-in Moves

1. *The RED player makes pile-in moves first.*
...
2. *The embarked unit makes an emergency disembark move. After doing so, it is unengaged.*
   ...
   ## Diagram: Overrun Fight

3. *The BLUE player has no Fights First units, so the RED player selects their next unit.*
4. *The RED player selects another Fights First unit. This unit is unengaged, but was engaged with the TRANSPORT at the start of the Fight step, so can make an overrun fight. It first makes a pile-in move to engage the unit that disembarked, then fights, destroying two enemy models.*
5. *The BLUE player's unit fights back, but inflicts no damage.*
...
* **After Moving:**
  ...
  *Each model moves up to 3". Models in base-contact with enemy models cannot be moved.*
  ...
  ## Diagram: Objective Consolidation

  *No enemy units are within 3" of this MONSTER unit, but an objective is within 3", so it moves within range of that objective.*
  ...
  *Page 44 | Illustration*
  ...
  \[Full-page photograph of an Astra Militarum armoured company and infantry defending fortified walls against a Tyranid swarm. No body text.]
  ...
  **BATTLEFIELDS AND TACTICS**
  ...
  \[Full-page section divider photograph of an Astra Militarum armoured force fighting Tyranids across a ruined cityscape.]
...
* Place two or more **terrain features** directly on the battlefield in such a way that together they define the boundary of an area.
  ...
  *Page 47 | Section 13*
  ...
  ## Diagram: Terrain Placed on a Mat

  *Two terrain features have been placed on a mat. The edges of this mat define the boundary of this terrain area. Both terrain features are ruins, so use the rules for dense terrain features.*

  ## Diagram: Terrain Placed on the Battlefield

  *Three terrain features have been placed directly on the battlefield. The players have agreed on the boundary of the terrain area defined by these features (the shaded rectangle). The BLUE features are dense terrain features and the RED feature is a light terrain feature.*



  \---

  # 13\. Terrain (continued)
...
* That model must remain within 1/2" horizontally of that **terrain feature**.
...
* After ending that move, that model is stable and no part of its base overhangs the outer edge of that surface.
  ...
  *As well as gaining superior lines of sight, models that ascend tall terrain features can benefit from the Plunging Fire rule (22.05).*
  ...
  *Page 49 | Section 13*
  ...
  ## Diagram: Terrain and Movement (top)

* *All sections of this dense terrain feature are more than 2" in height, so this MONSTER model cannot move through it and must move around it instead.*
* *These INFANTRY models can move through dense terrain features, such as the walls of this ruin.*

  ## Diagram: Terrain and Movement (bottom)

* *This INFANTRY model can move vertically and end its move on the top surface of this terrain feature, as it is stable and no part of its base overhangs the outer edge of that surface.*
* *This VEHICLE model cannot move through this dense terrain feature, but it can move vertically to ascend and descend sections that are more than 2" in height (provided it does not end that move on top of such sections).*
...
* *Unit D is not fully visible to unit E due to an intervening obscuring terrain area, so unit D has the benefit of cover.*

  ## Diagram: Hidden and Obscuring
...
* If both players have the same **level of control** over that **objective**, unless that **objective** is **secured** (see below), that **objective** is not controlled by either player.
  ...
  *Some units have abilities that are triggered when they control an objective, or when they secure an objective for your army.*



  \---

  # 14\. Objectives (diagram)

  *Page 53 | Section 14*

  ## Diagram: Controlling a Terrain Objective

* *This VEHICLE has an OC characteristic of 3, and it is within the terrain area.*
* *The models in this unit each have an OC characteristic of 1. Six of its models are within the terrain area.*
* *This VEHICLE has an OC characteristic of 2, and it is wholly within the terrain area.*
* *This unit is currently battle-shocked, so the OC characteristic of all of its models is '-'.*
...
* **EFFECT:** Resolve a **charge** with your unit (11.02). While doing so, before making the **charge roll**, you must select one of the following modes:
  ...
  *Stratagems are presented as shown above. Some feature optional conditions that carry an additional CP cost. This can depend on the effect you select (like in the example above) or other variables such as the keywords of the unit being targeted.*

  ## Stratagems Key

  The skull icon on each stratagem indicates when it is used:

* **Either player's turn** (green)
* **Your turn** (blue)
* **Opponent's turn** (red)
...
* **EFFECT:** Resolve the following sequence:
  ...
  # 15\. Stratagems (core stratagems continued)
...
* **EFFECT:** Your unit shoots using **snap shooting** (see below).
...
* It is not **eligible to declare a charge**.
  ...
  ## Example Action: DEPLOY DEVICE

  **EXAMPLE ACTION (CANNOT BE USED)**

  *Though it won't turn the tide of battle, deployment of this device will be instrumental to the war effort.*

* **STARTS:** Your Shooting phase.
* **UNITS:** One **INFANTRY** unit that is within a **terrain area** that is not within your deployment zone.
* **USE LIMIT:** Once per turn.
* **COMPLETES:** End of the turn.
* **EFFECT:** Set up one marker within 1" of your unit and within that **terrain area**.
  ...
  *Page 59 | Illustration*
  ...
  \[Full-page photograph of an Adepta Sororitas army arrayed before a sunlit cathedral ruin with a winged saint statue. No body text.]
  ...
  *Page 60 | Illustration*

  \[Full-page photograph of a battle scene with armoured vehicles and infantry advancing through ruins amid fire and smoke. No body text.]
  ...
  *Page 61 | Section divider*

  **ADVANCED RULES**

  \[Full-page section divider photograph of a battle scene with vehicles and infantry around ruined gothic structures.]
  ...
  **Shooting While Engaged with Monsters/Vehicles**
  ...
  *A unit that is engaged with an enemy MONSTER/VEHICLE unit is still not eligible to shoot, and so cannot make ranged attacks against that MONSTER/VEHICLE unit, unless that unit is eligible to shoot while engaged (e.g. because it is using close-quarters shooting).*
  ...
  # 17\. Monsters and Vehicles (diagram)

  *Page 63 | Section 17 | Advanced*

  ## Diagram: Engaged Monsters/Vehicles - Shooting

  **A)**

* *The VEHICLE can shoot at this INFANTRY unit using close-quarters shooting. While resolving those attacks, subtract 1 from hit rolls (excluding attacks made with \[CLOSE-QUARTERS] weapons).*
* *This INFANTRY unit can shoot at the VEHICLE using normal shooting. While resolving those attacks, subtract 1 from hit rolls. As the VEHICLE is engaged, \[BLAST] weapons cannot target it, but can target other unengaged units.*

  **B)**

* *The VEHICLE can shoot at this INFANTRY unit using close-quarters shooting. While resolving those attacks, subtract 1 from hit rolls. As the INFANTRY unit is engaged, \[BLAST] weapons cannot target it, but can target other unengaged units.*
...
* That **TRANSPORT** has sufficient remaining **transport capacity** for each model in that unit.
  ...
  In the active player's Movement phase, each friendly unit embarked within a **TRANSPORT** model can disembark from it by making a **disembark move** (see opposite).
  ...
  *++ Be strong in your ignorance ++*
  ...
  # 18\. Transports (move types)

  *Page 65 | Section 18 | Advanced*
...
* Persisting Rules Effects
  ...
  *Page 66 | Section 19 | Advanced*

  The heroes of your army rarely fight alone. Instead, they typically lead bands of warriors, forming an attached unit that acts as a single entity. This section explains how to form attached units and how they function on the battlefield.
  ...
  *++ Pain is an illusion caused by fear ++*
  ...
  # 19\. Attached Units (continued)

  *Page 67 | Section 19 | Advanced*
  ...
  **Example:** *An attached unit contains a leader model with the PSYKER keyword. While that model is part of that unit, that unit has the PSYKER keyword, even if the bodyguard models do not have that keyword. If that unit is attacked by a weapon with the \[ANTI-PSYKER 4+] ability, any unmodified wound roll of 4+ made against that unit is a critical wound, even if the attack itself is not allocated to that leader model.*
  ...
  Otherwise, abilities/rules that affect a unit (or models in it) apply to every model in an **attached** unit, until the source of that ability/rule is **destroyed**, as shown below.
...
|A specific model (e.g. the bearer of an **enhancement** or an item of wargear)|That model is **destroyed**.|

*\* This means leader/support units continue to benefit from their own 'while this model is leading a unit' abilities even after their bodyguard unit is destroyed, provided they started the battle in an attached unit.*
...
# 20\. Strategic Reserves (continued)

*Page 69 | Section 20 | Advanced*
...
# 21\. Flying and Surging (continued)

*Page 71 | Section 21 | Advanced*
...
# 22\. Other Rules and Abilities (continued)

*Page 73 | Section 22 | Advanced*
...
* *This attacking model is on ground level, but has the TOWERING keyword. The target unit is within 12" and contains models on ground level, so Plunging Fire improves the BS characteristic of those attacks by 1.*
...
\[Two photographs of aircraft models in flight: an Ork fighter alongside an Aeldari jetfighter over jungle terrain, and an Aeldari Crimson Hunter swooping over a ruined cityscape. No body text.]
...
*Page 76 | Illustration*

\[Full-page photograph of an Imperial Knights household fighting Chaos forces across a ruined battlefield. No body text.]
...
*Page 77 | Section divider*

**REFERENCE**

\[Full-page section divider photograph of Imperial Knights battling Chaos forces across a ruined cityscape.]
...
# 24\. Core Abilities (weapon abilities)
...
*High-explosive rounds can fell several warriors in a single blast, but firing them too close to comrades is unwise.*
...
*The hardiest warriors refuse to be laid low, even by wounds that should by all rights prove lethal.*
...
*Those possessed of lightning-fast reactions may strike before the opponent can react.*
...
*Some transports have dedicated platforms or firing ports from which embarked passengers can lay down a withering hail of munitions.*
...
*Specialist combatants may be assigned to front-line squads to bolster their fighting effectiveness.*

See Attached Units (19).

## SUPER-HEAVY WALKER (24.35)

*Monstrous creatures and gigantic engines of war loom over the battlefield like gods given form, striding over combatants and smashing through almost any obstacle that bars their passage.*
...
*Page 86 | Rules Appendix (continued in the app)*

## DIGITAL SUPPORT

The Warhammer 40,000 app contains an expanded range of definitions, rare rules interactions and frequently asked questions (FAQs).

These digital resources are designed to clarify any uncertainty and keep your battles as streamlined as possible. As such, they are reviewed and updated regularly in response to player feedback. The following pages present a selection of these supporting materials.
...
**Some Units Cannot Be at Half-Strength**

*If a model's W characteristic or a unit's starting strength cannot be evenly divided in half, that model or unit cannot be at half-strength (but can be below half-strength as described on the right).*
...
# Rules Appendix (continued)

*Page 87 | Rules Appendix*
...
Scan the code to get started with the Warhammer 40,000 app. \[QR code shown.]
...
*Page 88 | Rules Appendix (continued in the app)*
...
*A: No. Scout moves happen in the Resolve Pre-battle Abilities step of the battle, which comes after the Declare Battle Formations step and before the Begin the Battle step.*
